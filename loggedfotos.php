            ...
            <li class="nav-item">
		      ...
		      <div class="row">
		        ...
		        <div class="col-md-7 col-sm-8">
		          <h2>MINHAS FOTOS <span class="badge badge-pill badge-secondary">PHOTOS!!</span></h2>
		           <article class="noticia">
		            ...
		            <p>
		              Fortaleza<br>
		              <img src="minhafoto1.jpg" width="100%">
		            </p>
		          </article> <!-- /noticia -->
		          <article class="noticia">
		            <h2>Viagem 2017</h2>
		            ...
		            <p>
		              Hotel Beira Mar<br>
		              <img src="minhafoto3.jpg" width="100%">
		            </p>
		          </article> <!-- /noticia -->
		          <article class="noticia">
		            <h2>Passa tempo</h2>
		            ...
		            <p>
		              Manaus<br>
		              <img src="minhafoto2.jpg" width="100%">
		            </p>
		          </article> <!-- /noticia -->
		          <article class="noticia">
		            <h2>Viagem 2018</h2>
		            ...
		            <p>
		              Evento: CONEDU<br>
		              <img src="minhafoto4.jpg" width="100%">
		            </p>
		          </article> <!-- /noticia -->
		          <article class="noticia">
		            <h2>Viagem 2019</h2>
		            ...
		            <p>
		              Espanha<br>
		              <img src="minhafoto5.jpg" width="100%">
		            </p>
		          </article> <!-- /noticia -->
		          <article class="noticia">
		            ...
		            <p>
		              ...
		              <img src="minhafoto6.jpg" width="100%">
		            </p>
		          </article> <!-- /noticia -->
		          <article class="noticia">
		            <h2>Foto mais atual</h2>
		            <hr>
		            <h5>10/2020</h5>            
		            <p>
		              Manaus<br>
		              <img src="minhafoto7.jpg" width="100%">
		            </p>
		          </article> <!-- /noticia -->
